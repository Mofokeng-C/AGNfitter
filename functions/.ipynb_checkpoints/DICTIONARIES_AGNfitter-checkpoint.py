...
class MODELSDICT:
    ...
    def build(self):
        ...
        pickle.dump(COSMOS_modelsdict, f, protocol=2)
        f.close()
    ...
    def construct_dictionaryarray_filtered(self, z, filterdict,path):
        ...
        galaxy_object = pickle.load(file(path + 'models/GALAXY/bc03_275templates.pickle', 'rb')) 
        ...
        starburst_object = pickle.load(file(path + 'models/STARBURST/dalehelou_charyelbaz_v1.pickle', 'rb')) 
        ...
        bbb_object = pickle.load(file(path + 'models/BBB/richards.pickle', 'rb')) 
        ...
        torus_object = pickle.load(file(path + 'models/TORUS/silva_v1.pickle', 'rb')) 
